// Phase 7: SLO burn evaluator.
// Consumes recent rollups and computes error ratios vs configured objectives.
// Emits structured log lines when burn exceeds thresholds.
