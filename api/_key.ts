// Canonical key utilities (Phase 1 groundwork)
// Provides stable serialization for cache keys to prevent fragmentation.
// Usage: buildCacheKey('search', { q, country, page, pageSize, domains })
...
// Simple hash (optional) if we decide keys are too long later.
