          ...
          for (const p of ordered) {
            ...
            try {
              ...
              for (const s of strategies) {
                // sub-variants: default, no-pagination, and no-country versions for domain combos
                ...
                // Add no-country variants for all strategies to bypass 422 from domain+country
